...
module.exports = class EntidadeSinc {
  ...
  static async findAll(where) {
    const instance = new this();
    return await dbUtils.query(`select * from ${instance.tabela} where 1 = 1 ${where || ''}`);
  }
  ...
  static async findFirst() {
    const instance = new this();
    return await dbUtils.queryFindOne(`select * from ${instance.tabela} limit 1`);
  }
