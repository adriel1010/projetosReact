...
class LineChartClass extends React.Component {
  ...
  componentWillReceiveProps(props) {
    if (this.props.valores != props.valores) {
  ...
  render() {
    return (
        ...
        ref={e => this.lineChart = e}
        onClick={(e) => {
          const points = this.lineChart.getPointsAtEvent(e);
          if (points && points.length > 0) {
            if (this.props.onClick) this.props.onClick(points[0].label);
          }
        }}
